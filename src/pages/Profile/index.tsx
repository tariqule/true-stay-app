...
export const ProfileScreen = (props: any) => {
    return (
        <View style={styles.bachgrd}>
            ...
            <Avatar
                    rounded
                    icon={{ name: 'chevron-left', type: 'font-awesome', color: "#0077B6"}}
                />
            ...
            <View >
                <Text style={styles.textBox}>Hi! My name is John, I’m a creative geek from San Francisco, CA. I enjoy creating eye candy solutions for web and mobile apps. Contact me any time</Text>
            </View>
